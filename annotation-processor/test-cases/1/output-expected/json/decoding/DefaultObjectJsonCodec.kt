...
internal object DefaultObjectJsonCodec : AbstractJsonEncoderCodec<DefaultObject, CustomCodingContext>() {
	override fun JsonEncoder<CustomCodingContext>.encode(`value`: DefaultObject) {
		writeIntoMap {
		}
	}
}
