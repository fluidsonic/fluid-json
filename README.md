...
dependencies {
    kapt("com.github.fluidsonic:fluid-json-annotation-processor:0.9.20")
    implementation("com.github.fluidsonic:fluid-json-coding-jdk8:0.9.20")
}
```
...
```kotlin
dependencies {
    implementation("com.github.fluidsonic:fluid-json-ktor-client:0.9.20")
}
```
